                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 getResourceLocator(),
                                 getString("_UI_Tracker_owners_feature"),
                                 getString("_UI_PropertyDescriptor_description", "_UI_Tracker_owners_feature", "_UI_Tracker_type"),
                                 TrackerPackage.Literals.TRACKER__OWNERS,
                                 true,
                                 false,
                                 true,
                                 null,
	...
	protected void addOriginsRepositoryPropertyDescriptor(Object object) {
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 getResourceLocator(),
                                 getString("_UI_Tracker_originsRepository_feature"),
                                 getString("_UI_PropertyDescriptor_description", "_UI_Tracker_originsRepository_feature", "_UI_Tracker_type"),
                                 TrackerPackage.Literals.TRACKER__ORIGINS_REPOSITORY,
                                 true,
                                 false,
                                 true,
                                 null,
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 ...
                                 TrackerPackage.Literals.TRACKER__CATEGORIES_REPOSITORY,
                                 true,
                                 false,
                                 true,
                                 null,
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 ...
                                 TrackerPackage.Literals.TRACKER__OPERATIONS_TITLES_REPOSITORIES,
                                 true,
                                 false,
                                 true,
                                 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
                ...
                newChildDescriptors.add
                        (createChildParameter
                                (TrackerPackage.Literals.TRACKER__OWNERS,
                                 TrackerFactory.eINSTANCE.createOwner()));
