 ...
 * instance.
 */
public class AddSpendingCategoryWizardPage extends AbstractAddWizardPage {
	...
	public AddSpendingCategoryWizardPage(String pageTitle, Tracker tracker) {
		super(MessageFormat.format(AddSpendingCategoryWizardPage.PAGE_NAME, pageTitle));
		this.tracker=tracker;
		setTitle(AddSpendingCategoryWizardPage.PAGE_TITLE);
		setDescription(AddSpendingCategoryWizardPage.WIZARD_DESCRIPTION);
	}
