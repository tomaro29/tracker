...
public class CategoryItemProvider extends TitleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TrackerPackage.Literals.CATEGORY__SUB_CATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TrackerPackage.Literals.CATEGORY__SUB_CATEGORIES, TrackerFactory.eINSTANCE.createCategory()));
	}
