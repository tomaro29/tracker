 ...
 * <li>{@link fr.rostren.tracker.impl.AccountImpl#getAmount <em>Amount</em>}
 * </li>
 * <li>{@link fr.rostren.tracker.impl.AccountImpl#getIdentifier
 * <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class AccountImpl extends EObjectImpl implements Account {
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.ACCOUNT__IDENTIFIER, oldIdentifier,
		    identifier));
    }
