 ...
 * @generated
 */
public class TrackerActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
	    TrackerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
	@Override
	public void run() {
	    try {
    ...
    protected IAction refreshViewerAction = new Action(
	    TrackerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	@Override
	...
	IMenuManager submenuManager = new MenuManager(TrackerEditorPlugin.INSTANCE.getString("_UI_TrackerEditor_menu"),
		"fr.rostren.trackerMenuID");
	...
	createSiblingMenuManager = new MenuManager(
		TrackerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
