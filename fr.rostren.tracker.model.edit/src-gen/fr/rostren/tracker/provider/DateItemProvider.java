 ...
 * @generated
 */
public class DateItemProvider extends ItemProviderAdapter
	...
	protected void addDayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Date_day_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Date_day_feature", "_UI_Date_type"), TrackerPackage.Literals.DATE__DAY,
	...
	protected void addMonthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Date_month_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Date_month_feature", "_UI_Date_type"),
				TrackerPackage.Literals.DATE__MONTH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addYearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Date_year_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Date_year_feature", "_UI_Date_type"), TrackerPackage.Literals.DATE__YEAR,
				true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
