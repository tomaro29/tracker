 ...
 * @generated
 */
public class TransferItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transfer_incomingAccount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transfer_incomingAccount_feature", "_UI_Transfer_type"),
				 TrackerPackage.Literals.TRANSFER__INCOMING_ACCOUNT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutgoingAccountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transfer_outgoingAccount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transfer_outgoingAccount_feature", "_UI_Transfer_type"),
				 TrackerPackage.Literals.TRANSFER__OUTGOING_ACCOUNT,
				 true,
				 false,
				 true,
				 null,
