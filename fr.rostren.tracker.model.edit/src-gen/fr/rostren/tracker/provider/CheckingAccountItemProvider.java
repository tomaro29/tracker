...
public class CheckingAccountItemProvider extends AccountItemProvider {
    ...
    /**
     * This returns CheckingAccount.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
	...
	return label == null || label.length() == 0 ? getString("_UI_CheckingAccount_type")
	...
	newChildDescriptors.add(createChildParameter(TrackerPackage.Literals.CHECKING_ACCOUNT__OPERATIONS,
