...
/**
 * This is the item provider adapter for a {@link fr.rostren.tracker.Tracker}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TrackerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Tracker_owners_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Tracker_owners_feature",
				"_UI_Tracker_type"),
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Tracker_originsRepository_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Tracker_originsRepository_feature",
				"_UI_Tracker_type"),
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Tracker_categoriesRepository_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Tracker_categoriesRepository_feature",
				"_UI_Tracker_type"),
			TrackerPackage.Literals.TRACKER__CATEGORIES_REPOSITORY, true, false, true, null, null, null));
    }

    /**
     * This adds a property descriptor for the Operations Titles Repositories
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Tracker_operationsTitlesRepositories_feature"),
			getString("_UI_PropertyDescriptor_description",
				"_UI_Tracker_operationsTitlesRepositories_feature", "_UI_Tracker_type"),
    ...
    /**
     * This returns Tracker.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
	...
	newChildDescriptors.add(
		createChildParameter(TrackerPackage.Literals.TRACKER__OWNERS, TrackerFactory.eINSTANCE.createOwner()));

	newChildDescriptors.add(createChildParameter(TrackerPackage.Literals.TRACKER__ORIGINS_REPOSITORY,
		TrackerFactory.eINSTANCE.createOriginsRepository()));

	newChildDescriptors.add(createChildParameter(TrackerPackage.Literals.TRACKER__CATEGORIES_REPOSITORY,
		TrackerFactory.eINSTANCE.createCategoriesRepository()));

	newChildDescriptors.add(createChildParameter(TrackerPackage.Literals.TRACKER__OPERATIONS_TITLES_REPOSITORIES,
		TrackerFactory.eINSTANCE.createOperationsTitleRepository()));
    }
