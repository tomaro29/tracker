 ...
 * <ul>
 * <li>
 * {@link fr.rostren.tracker.impl.OperationsTitleRepositoryImpl#getOperationsTitles
...
public class OperationsTitleRepositoryImpl extends EObjectImpl implements OperationsTitleRepository {
    /**
     * The cached value of the '{@link #getOperationsTitles()
     * <em>Operations Titles</em>}' containment reference list. <!--
	...
	if (operationsTitles == null) {
	    operationsTitles = new EObjectContainmentEList<OperationTitle>(OperationTitle.class, this,
		    TrackerPackage.OPERATIONS_TITLE_REPOSITORY__OPERATIONS_TITLES);
	}
