 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.impl.TransferImpl#getIncomingAccount
 * <em>Incoming Account</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.TransferImpl#getOutgoingAccount
 * <em>Outgoing Account</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TransferImpl extends OperationImpl implements Transfer {
    /**
     * The cached value of the '{@link #getIncomingAccount()
     * <em>Incoming Account</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getOutgoingAccount()
     * <em>Outgoing Account</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
	...
	if (incomingAccount != null && incomingAccount.eIsProxy()) {
		...
		if (eNotificationRequired())
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackerPackage.TRANSFER__INCOMING_ACCOUNT,
			    oldIncomingAccount, incomingAccount));
	    }
	}
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.TRANSFER__INCOMING_ACCOUNT,
		    oldIncomingAccount, incomingAccount));
    }
	...
	if (outgoingAccount != null && outgoingAccount.eIsProxy()) {
		...
		if (eNotificationRequired())
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackerPackage.TRANSFER__OUTGOING_ACCOUNT,
			    oldOutgoingAccount, outgoingAccount));
	    }
	}
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.TRANSFER__OUTGOING_ACCOUNT,
		    oldOutgoingAccount, outgoingAccount));
    }
