...
public class TrackerImpl extends EObjectImpl implements Tracker {
	...
	public NotificationChain basicSetCategoriesRepository(CategoriesRepository newCategoriesRepository, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification=new ENotificationImpl(this, Notification.SET, TrackerPackage.TRACKER__CATEGORIES_REPOSITORY, oldCategoriesRepository,
	...
	public NotificationChain basicSetOperationsTitlesRepositories(OperationsTitleRepository newOperationsTitlesRepositories, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification=new ENotificationImpl(this, Notification.SET, TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, oldOperationsTitlesRepositories,
	...
	public void setOperationsTitlesRepositories(OperationsTitleRepository newOperationsTitlesRepositories) {
		if (newOperationsTitlesRepositories != operationsTitlesRepositories) {
			...
			if (operationsTitlesRepositories != null)
				msgs=((InternalEObject)operationsTitlesRepositories).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, null,
						msgs);
			if (newOperationsTitlesRepositories != null)
				msgs=((InternalEObject)newOperationsTitlesRepositories).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, newOperationsTitlesRepositories,
					newOperationsTitlesRepositories));
	}
