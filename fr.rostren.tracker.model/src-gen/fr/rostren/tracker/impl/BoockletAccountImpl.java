 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.impl.BoockletAccountImpl#getTransfers
 * <em>Transfers</em>}</li>
 * </ul>
 *
 * @generated
...
public class BoockletAccountImpl extends AccountImpl implements BoockletAccount {
    /**
     * The cached value of the '{@link #getTransfers() <em>Transfers</em>}'
	...
	if (transfers == null) {
	    transfers = new EObjectContainmentEList<Transfer>(Transfer.class, this,
		    TrackerPackage.BOOCKLET_ACCOUNT__TRANSFERS);
	}
	return transfers;
    }
