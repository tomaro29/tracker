 ...
 * {@link fr.rostren.tracker.OperationTitle} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class OperationTitleItemProvider extends TitleItemProvider {
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_OperationTitle_categories_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_OperationTitle_categories_feature",
				"_UI_OperationTitle_type"),
			TrackerPackage.Literals.OPERATION_TITLE__CATEGORIES, true, false, true, null, null, null));
    }

    /**
     * This returns OperationTitle.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
