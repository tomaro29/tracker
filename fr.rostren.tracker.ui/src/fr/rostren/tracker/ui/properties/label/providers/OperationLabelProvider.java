...
public class OperationLabelProvider extends AbstractLabelProvider {
	...
	if (element instanceof Operation) {
	    return getOperationTitle((Operation) element) + STRING_SEPARATOR + getOperationDate((Operation) element);
	}
	...
	return operation.getOperationTitle() == null || StringUtils.isEmpty(operation.getOperationTitle().getTitle())
		? STRING_UNDEFINED_TITLE : operation.getOperationTitle().getTitle();
    }

    private String getOperationDate(Operation operation) {
	return operation.getDate() == null ? STRING_UNDEFINED_DATE : operation.getDate().toString();
    }
}
