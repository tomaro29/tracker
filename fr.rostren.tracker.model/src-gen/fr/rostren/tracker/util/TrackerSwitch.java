...
public class TrackerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
                switch (classifierID) {
                        ...
                        case TrackerPackage.BOOCKLET_ACCOUNT: {
                                ...
                                if (result == null) result = caseAccount(boockletAccount);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        ...
                        case TrackerPackage.CREDIT_OPERATION: {
                                CreditOperation creditOperation = (CreditOperation)theEObject;
                                T result = caseCreditOperation(creditOperation);
                                if (result == null) result = caseOperation(creditOperation);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case TrackerPackage.DEBIT_OPERATION: {
                                DebitOperation debitOperation = (DebitOperation)theEObject;
                                T result = caseDebitOperation(debitOperation);
                                if (result == null) result = caseOperation(debitOperation);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case TrackerPackage.TRANSFER: {
                                ...
                                if (result == null) result = caseOperation(transfer);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case TrackerPackage.INCOMING_TRANSFER: {
                                IncomingTransfer incomingTransfer = (IncomingTransfer)theEObject;
                                T result = caseIncomingTransfer(incomingTransfer);
                                if (result == null) result = caseTransfer(incomingTransfer);
                                if (result == null) result = caseOperation(incomingTransfer);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case TrackerPackage.OUTGOING_TRANSFER: {
                                OutgoingTransfer outgoingTransfer = (OutgoingTransfer)theEObject;
                                T result = caseOutgoingTransfer(outgoingTransfer);
                                if (result == null) result = caseTransfer(outgoingTransfer);
                                if (result == null) result = caseOperation(outgoingTransfer);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        ...
                        case TrackerPackage.CATEGORY: {
                                ...
                                if (result == null) result = caseTitle(category);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case TrackerPackage.OPERATION_TITLE: {
                                ...
                                if (result == null) result = caseTitle(operationTitle);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
	...
	/**
         * Returns the result of interpreting the object as an instance of '<em>Credit Operation</em>'.
         * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Credit Operation</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
	public T caseCreditOperation(CreditOperation object) {
                return null;
        }

	/**
         * Returns the result of interpreting the object as an instance of '<em>Debit Operation</em>'.
         * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Debit Operation</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
	public T caseDebitOperation(DebitOperation object) {
                return null;
        }
	...
	/**
         * Returns the result of interpreting the object as an instance of '<em>Incoming Transfer</em>'.
         * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Incoming Transfer</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
	public T caseIncomingTransfer(IncomingTransfer object) {
                return null;
        }

	/**
         * Returns the result of interpreting the object as an instance of '<em>Outgoing Transfer</em>'.
         * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Outgoing Transfer</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
	public T caseOutgoingTransfer(OutgoingTransfer object) {
                return null;
        }
