...
public class TrackerPackageImpl extends EPackageImpl implements TrackerPackage {
	...
	TrackerPackageImpl theTrackerPackage = (TrackerPackageImpl) (EPackage.Registry.INSTANCE
		.get(eNS_URI) instanceof TrackerPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	initEReference(getOwner_Accounts(), this.getAccount(), null, "accounts", null, 1, -1, Owner.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getOwner_FirstName(), ecorePackage.getEString(), "firstName", null, 0, 1, Owner.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getOwner_LastName(), ecorePackage.getEString(), "lastName", null, 0, 1, Owner.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(accountEClass, Account.class, "Account", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getAccount_Name(), ecorePackage.getEString(), "name", null, 0, 1, Account.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAccount_Amount(), ecorePackage.getEFloat(), "amount", null, 0, 1, Account.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAccount_Identifier(), ecorePackage.getEInt(), "identifier", null, 0, 1, Account.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(checkingAccountEClass, CheckingAccount.class, "CheckingAccount", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEReference(getCheckingAccount_Operations(), this.getOperation(), null, "operations", null, 0, -1,
		CheckingAccount.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(boockletAccountEClass, BoockletAccount.class, "BoockletAccount", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEReference(getBoockletAccount_Transfers(), this.getTransfer(), null, "transfers", null, 0, -1,
		BoockletAccount.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(operationEClass, Operation.class, "Operation", IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getOperation_TotalAmount(), ecorePackage.getEBigDecimal(), "totalAmount", null, 0, 1,
		Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
		!IS_DERIVED, IS_ORDERED);
	initEReference(getOperation_OperationTitle(), this.getOperationTitle(), null, "operationTitle", null, 1, 1,
		Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getOperation_SubAmounts(), this.getAmount(), null, "subAmounts", null, 1, -1, Operation.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getOperation_Date(), this.getDate(), null, "date", null, 0, 1, Operation.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
		IS_ORDERED);
	initEReference(getOperation_Origin(), this.getOrigin(), this.getOrigin_Operations(), "origin", null, 1, 1,
		Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	initEReference(getTransfer_IncomingAccount(), this.getAccount(), null, "incomingAccount", null, 0, 1,
		Transfer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getTransfer_OutgoingAccount(), this.getAccount(), null, "outgoingAccount", null, 0, 1,
		Transfer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(incomingEClass, Incoming.class, "Incoming", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);

	initEClass(outgoingEClass, Outgoing.class, "Outgoing", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);

	initEClass(titleEClass, Title.class, "Title", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getTitle_Title(), ecorePackage.getEString(), "title", null, 0, 1, Title.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(categoryEClass, Category.class, "Category", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEReference(getCategory_OperationTitles(), this.getOperationTitle(), this.getOperationTitle_Categories(),
		"operationTitles", null, 0, -1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getCategory_Description(), ecorePackage.getEString(), "description", null, 0, 1, Category.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(operationTitleEClass, OperationTitle.class, "OperationTitle", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEReference(getOperationTitle_Categories(), this.getCategory(), this.getCategory_OperationTitles(),
		"categories", null, 0, -1, OperationTitle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(amountEClass, Amount.class, "Amount", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEReference(getAmount_Category(), this.getCategory(), null, "category", null, 1, 1, Amount.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAmount_Value(), ecorePackage.getEBigDecimal(), "value", null, 0, 1, Amount.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(operationTitleServiceEClass, OperationTitleService.class, "OperationTitleService", !IS_ABSTRACT,
	...
	initEClass(categoryServiceEClass, CategoryService.class, "CategoryService", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	...
	initEClass(accountServiceEClass, AccountService.class, "AccountService", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);

	op = addEOperation(accountServiceEClass, ecorePackage.getEFloat(), "sumPerCategory", 0, 1, IS_UNIQUE,
		IS_ORDERED);
	...
	op = addEOperation(accountServiceEClass, ecorePackage.getEFloat(), "averagePerCategory", 0, 1, IS_UNIQUE,
		IS_ORDERED);
	addEParameter(op, this.getAccount(), "account", 0, 1, IS_UNIQUE, IS_ORDERED);
	addEParameter(op, this.getCategory(), "category", 0, 1, IS_UNIQUE, IS_ORDERED);
	addEParameter(op, this.getMonth(), "month", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	initEClass(operationServiceEClass, OperationService.class, "OperationService", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	...
	initEClass(categoriesRepositoryEClass, CategoriesRepository.class, "CategoriesRepository", !IS_ABSTRACT,
		!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEReference(getCategoriesRepository_Categories(), this.getCategory(), null, "categories", null, 0, -1,
		CategoriesRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
		!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(dateEClass, Date.class, "Date", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getDate_Day(), ecorePackage.getEInt(), "day", null, 0, 1, Date.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getDate_Month(), this.getMonth(), "month", null, 0, 1, Date.class, !IS_TRANSIENT, !IS_VOLATILE,
		IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getDate_Year(), ecorePackage.getEInt(), "year", null, 0, 1, Date.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(originEClass, Origin.class, "Origin", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getOrigin_Type(), this.getOriginType(), "type", null, 0, 1, Origin.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getOrigin_Identifier(), ecorePackage.getEString(), "identifier", null, 0, 1, Origin.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getOrigin_Operations(), this.getOperation(), this.getOperation_Origin(), "operations", null, 0,
		-1, Origin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(originsRepositoryEClass, OriginsRepository.class, "OriginsRepository", !IS_ABSTRACT, !IS_INTERFACE,
		IS_GENERATED_INSTANCE_CLASS);
	initEReference(getOriginsRepository_Origins(), this.getOrigin(), null, "origins", null, 0, -1,
		OriginsRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(trackerEClass, Tracker.class, "Tracker", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEReference(getTracker_Owners(), this.getOwner(), null, "owners", null, 0, -1, Tracker.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
		IS_ORDERED);
	initEReference(getTracker_OriginsRepository(), this.getOriginsRepository(), null, "originsRepository", null, 1,
		1, Tracker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getTracker_CategoriesRepository(), this.getCategoriesRepository(), null, "categoriesRepository",
		null, 1, 1, Tracker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
		!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getTracker_OperationsTitlesRepositories(), this.getOperationsTitleRepository(), null,
		"operationsTitlesRepositories", null, 1, 1, Tracker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

	initEClass(operationsTitleRepositoryEClass, OperationsTitleRepository.class, "OperationsTitleRepository",
		!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEReference(getOperationsTitleRepository_OperationsTitles(), this.getOperationTitle(), null,
		"operationsTitles", null, 0, -1, OperationsTitleRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
    ...
    /**
     * Initializes the annotations for <b>isUnique</b>. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
