 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.impl.OwnerImpl#getAccounts <em>Accounts</em>}
 * </li>
 * <li>{@link fr.rostren.tracker.impl.OwnerImpl#getFirstName <em>First Name</em>
 * }</li>
 * <li>{@link fr.rostren.tracker.impl.OwnerImpl#getLastName <em>Last Name</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public class OwnerImpl extends EObjectImpl implements Owner {
    /**
     * The cached value of the '{@link #getAccounts() <em>Accounts</em>}'
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.OWNER__FIRST_NAME, oldFirstName,
		    firstName));
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.OWNER__LAST_NAME, oldLastName,
		    lastName));
    }
