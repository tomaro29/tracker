 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.impl.TrackerImpl#getOwners <em>Owners</em>}
 * </li>
 * <li>{@link fr.rostren.tracker.impl.TrackerImpl#getOriginsRepository
 * <em>Origins Repository</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.TrackerImpl#getCategoriesRepository
 * <em>Categories Repository</em>}</li>
 * <li>
 * {@link fr.rostren.tracker.impl.TrackerImpl#getOperationsTitlesRepositories
...
public class TrackerImpl extends EObjectImpl implements Tracker {
    /**
     * The cached value of the '{@link #getOwners() <em>Owners</em>}'
    ...
    /**
     * The cached value of the '{@link #getOriginsRepository()
    ...
    /**
     * The cached value of the '{@link #getCategoriesRepository()
    ...
    /**
     * The cached value of the '{@link #getOperationsTitlesRepositories()
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.TRACKER__ORIGINS_REPOSITORY, oldOriginsRepository, newOriginsRepository);
	    if (msgs == null)
		msgs = notification;
	    else
	...
	if (newOriginsRepository != originsRepository) {
		...
		msgs = ((InternalEObject) originsRepository).eInverseRemove(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__ORIGINS_REPOSITORY, null, msgs);
	    if (newOriginsRepository != null)
		msgs = ((InternalEObject) newOriginsRepository).eInverseAdd(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__ORIGINS_REPOSITORY, null, msgs);
	    msgs = basicSetOriginsRepository(newOriginsRepository, msgs);
	    if (msgs != null)
		msgs.dispatch();
	} else if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.TRACKER__ORIGINS_REPOSITORY,
		    newOriginsRepository, newOriginsRepository));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetCategoriesRepository(CategoriesRepository newCategoriesRepository,
	    NotificationChain msgs) {
	CategoriesRepository oldCategoriesRepository = categoriesRepository;
	categoriesRepository = newCategoriesRepository;
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.TRACKER__CATEGORIES_REPOSITORY, oldCategoriesRepository, newCategoriesRepository);
	    if (msgs == null)
		msgs = notification;
	    else
		msgs.add(notification);
	...
	if (newCategoriesRepository != categoriesRepository) {
		...
		msgs = ((InternalEObject) categoriesRepository).eInverseRemove(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__CATEGORIES_REPOSITORY, null, msgs);
	    if (newCategoriesRepository != null)
		msgs = ((InternalEObject) newCategoriesRepository).eInverseAdd(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__CATEGORIES_REPOSITORY, null, msgs);
	    msgs = basicSetCategoriesRepository(newCategoriesRepository, msgs);
	    if (msgs != null)
		msgs.dispatch();
	} else if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.TRACKER__CATEGORIES_REPOSITORY,
		    newCategoriesRepository, newCategoriesRepository));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetOperationsTitlesRepositories(
	    OperationsTitleRepository newOperationsTitlesRepositories, NotificationChain msgs) {
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, oldOperationsTitlesRepositories,
		    newOperationsTitlesRepositories);
	    if (msgs == null)
		msgs = notification;
	    else
		msgs.add(notification);
	...
	if (newOperationsTitlesRepositories != operationsTitlesRepositories) {
		...
		msgs = ((InternalEObject) operationsTitlesRepositories).eInverseRemove(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, null, msgs);
	    if (newOperationsTitlesRepositories != null)
		msgs = ((InternalEObject) newOperationsTitlesRepositories).eInverseAdd(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, null, msgs);
	    ...
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.TRACKER__OPERATIONS_TITLES_REPOSITORIES, newOperationsTitlesRepositories,
		    newOperationsTitlesRepositories));
    }
