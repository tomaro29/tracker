...
public class CreditOperationItemProvider extends OperationItemProvider
	...
	/**
	 * This returns CreditOperation.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/CreditOperation"));
	}
	...
	public String getText(Object object) {
		String operationTitle = ((CreditOperation) object).getOperationTitle()
				.getTitle();
		String operationAmount = ((BigDecimal) ((CreditOperation) object)
				.getTotalAmount()).toString();

		if (operationTitle == null) {
			return "New " + getString("_UI_CreditOperation_type");
		} else if (operationTitle.length() == 0) {
			return getString("_UI_CreditOperation_type")
