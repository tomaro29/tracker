...
/**
 * This is the item provider adapter for a {@link fr.rostren.tracker.Incoming} object.
...
public class IncomingItemProvider extends TransferItemProvider {
	...
	public String getText(Object object) {
		...
		if (operationTitle == null || operationTitle.length() == 0) {
			return getString("_UI_Incoming_type") + ": " + operationDate + " --> Undefined Operation Title = " + operationAmount + " euros";
		}
		return getString("_UI_Incoming_type") + ": " + operationDate + " --> " + operationTitle + " = " + operationAmount + " euros";
	}
