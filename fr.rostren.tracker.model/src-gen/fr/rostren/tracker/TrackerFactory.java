...
public interface TrackerFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Owner</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Credit</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Debit</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Incoming</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Outgoing</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Amount</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Origin</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Tracker</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
