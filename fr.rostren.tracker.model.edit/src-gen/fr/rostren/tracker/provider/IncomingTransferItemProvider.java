...
/**
 * This is the item provider adapter for a {@link fr.rostren.tracker.IncomingTransfer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncomingTransferItemProvider extends TransferItemProvider {
	...
	/**
	 * This returns IncomingTransfer.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String operationTitle = ((IncomingTransfer) object).getOperationTitle()
				.getTitle();
		String operationAmount = ((BigDecimal) ((IncomingTransfer) object)
				.getTotalAmount()).toString();

		if (operationTitle == null) {
			return "New " + getString("_UI_IncomingTransfer_type");
		} else if (operationTitle.length() == 0) {
			return getString("_UI_IncomingTransfer_type")
