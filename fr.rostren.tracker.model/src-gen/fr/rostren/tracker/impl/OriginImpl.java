 ...
 * <li>{@link fr.rostren.tracker.impl.OriginImpl#getIdentifier
 * <em>Identifier</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.OriginImpl#getOperations
 * <em>Operations</em>}</li>
 * </ul>
 *
 * @generated
...
public class OriginImpl extends EObjectImpl implements Origin {
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.ORIGIN__IDENTIFIER, oldIdentifier,
		    identifier));
    }
	...
	if (operations == null) {
	    operations = new EObjectWithInverseResolvingEList<Operation>(Operation.class, this,
		    TrackerPackage.ORIGIN__OPERATIONS, TrackerPackage.OPERATION__ORIGIN);
	}
	return operations;
    }
