...
/**
 * This is the item provider adapter for a {@link fr.rostren.tracker.Transfer}
...
public class TransferItemProvider extends OperationItemProvider {
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Transfer_incomingAccount_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Transfer_incomingAccount_feature",
				"_UI_Transfer_type"),
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Transfer_outgoingAccount_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Transfer_outgoingAccount_feature",
				"_UI_Transfer_type"),
	...
	return label == null || label.length() == 0 ? getString("_UI_Transfer_type")
