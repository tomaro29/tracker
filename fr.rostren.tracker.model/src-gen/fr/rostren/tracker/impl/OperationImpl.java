 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.impl.OperationImpl#getTotalAmount
 * <em>Total Amount</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.OperationImpl#getOperationTitle
 * <em>Operation Title</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.OperationImpl#getSubAmounts
 * <em>Sub Amounts</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.OperationImpl#getDate <em>Date</em>}</li>
 * <li>{@link fr.rostren.tracker.impl.OperationImpl#getOrigin <em>Origin</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public abstract class OperationImpl extends EObjectImpl implements Operation {
    /**
     * The default value of the '{@link #getTotalAmount() <em>Total Amount</em>}
    ...
    /**
     * The cached value of the '{@link #getTotalAmount() <em>Total Amount</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getTotalAmount()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getOperationTitle()
     * <em>Operation Title</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getSubAmounts() <em>Sub Amounts</em>}'
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.OPERATION__DATE, oldDate, newDate);
	    if (msgs == null)
		msgs = notification;
	    else
	...
	if (newDate != date) {
		...
		msgs = ((InternalEObject) date).eInverseRemove(this,
			EOPPOSITE_FEATURE_BASE - TrackerPackage.OPERATION__DATE, null, msgs);
	    if (newDate != null)
	...
	if (origin != null && origin.eIsProxy()) {
	    ...
	    if (origin != oldOrigin) {
		if (eNotificationRequired())
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackerPackage.OPERATION__ORIGIN,
			    oldOrigin, origin));
	    }
	}
	return origin;
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    TrackerPackage.OPERATION__ORIGIN, oldOrigin, newOrigin);
	    if (msgs == null)
		msgs = notification;
	    else
		msgs.add(notification);
	...
	if (newOrigin != origin) {
	    NotificationChain msgs = null;
	    if (origin != null)
		msgs = ((InternalEObject) origin).eInverseRemove(this, TrackerPackage.ORIGIN__OPERATIONS, Origin.class,
			msgs);
	    if (newOrigin != null)
		msgs = ((InternalEObject) newOrigin).eInverseAdd(this, TrackerPackage.ORIGIN__OPERATIONS, Origin.class,
			msgs);
	    msgs = basicSetOrigin(newOrigin, msgs);
	    if (msgs != null)
		msgs.dispatch();
	} else if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.OPERATION__ORIGIN, newOrigin,
		    newOrigin));
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.OPERATION__TOTAL_AMOUNT,
	...
	if (operationTitle != null && operationTitle.eIsProxy()) {
		...
		if (eNotificationRequired())
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackerPackage.OPERATION__OPERATION_TITLE,
			    oldOperationTitle, operationTitle));
	    }
	}
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackerPackage.OPERATION__OPERATION_TITLE,
		    oldOperationTitle, operationTitle));
    }
