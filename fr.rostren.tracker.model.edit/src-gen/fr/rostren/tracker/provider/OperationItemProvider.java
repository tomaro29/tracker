		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_totalAmount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_totalAmount_feature", "_UI_Operation_type"),
				 TrackerPackage.Literals.OPERATION__TOTAL_AMOUNT,
				 true,
				 false,
				 false,
	...
	protected void addOriginPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_origin_feature", "_UI_Operation_type"),
				 TrackerPackage.Literals.OPERATION__ORIGIN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.OPERATION__OPERATION_TITLE,
				 TrackerFactory.eINSTANCE.createOperationTitle()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.OPERATION__SUB_AMOUNTS,
				 TrackerFactory.eINSTANCE.createAmount()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.OPERATION__DATE,
				 TrackerFactory.eINSTANCE.createDate()));
	}
