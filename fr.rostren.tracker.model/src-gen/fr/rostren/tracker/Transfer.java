 ...
 * </p>
 * <ul>
 * <li>{@link fr.rostren.tracker.Transfer#getIncomingAccount
 * <em>Incoming Account</em>}</li>
 * <li>{@link fr.rostren.tracker.Transfer#getOutgoingAccount
...
public interface Transfer extends Operation {
     ...
     * 
     * @param value
     *            the new value of the '<em>Incoming Account</em>' reference.
     ...
     * 
     * @param value
     *            the new value of the '<em>Outgoing Account</em>' reference.
