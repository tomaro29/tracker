 ...
 * @generated
 */
public class OriginItemProvider extends ItemProviderAdapter
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Origin_type_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Origin_type_feature", "_UI_Origin_type"),
				TrackerPackage.Literals.ORIGIN__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Origin_identifier_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Origin_identifier_feature", "_UI_Origin_type"),
				TrackerPackage.Literals.ORIGIN__IDENTIFIER, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addOperationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Origin_operations_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Origin_operations_feature", "_UI_Origin_type"),
	...
	public Object getImage(Object object) {
		...
		if (originType != null && originType.equals(OriginType.PDF_FILE))
			return overlayImage(object, getResourceLocator().getImage("full/obj16/pdf"));
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Origin_type") : getString("_UI_Origin_type") + " " + label + " --> " + labelIdentifier;
	}
