...
/**
 * This is the item provider adapter for a {@link fr.rostren.tracker.Category}
...
public class CategoryItemProvider extends TitleItemProvider {
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Category_operationTitles_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Category_operationTitles_feature",
				"_UI_Category_type"),
	...
	itemPropertyDescriptors
		.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			getResourceLocator(), getString("_UI_Category_description_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Category_description_feature",
				"_UI_Category_type"),
			TrackerPackage.Literals.CATEGORY__DESCRIPTION, true, false, false,
